  ...
  export default {
          ...
          series: [
            {
              ...
              // 展示的圆的位置
              center: ['50%', centery],
              data: data.shopboard.numberData,
              itemStyle: {
                // 强调的展示
                emphasis: {
                  shadowBlur: 10,
    ...
    mounted() {
      this.$nextTick(function() {
        this.drawbar('salebar');
        if (document.body.clientWidth < 470) {
          this.drawpie('salepie', '70%');
        } else {
          this.drawpie('salepie', '60%');
        }
