    ...
    mounted() {
      this.$nextTick(function() {
        ...
        if (document.body.clientWidth < 470) {
          this.drawpie('jinpie', '70%');
        } else {
          this.drawpie('jinpie', '60%');
        }
        ...
        window.onresize = function() {
          ...
          resizeTimer = setTimeout(function() {
            that.drawbar('vbar');
            if (document.body.clientWidth < 470) {
              that.drawpie('jinppie', '70%');
            } else {
              that.drawpie('jinpie', '60%');
            }
          }, 100);
        }
      });
